  ...
  const vm = new Vue({
    ...
    methods: {
      setAuthenticated(status, data) {
        // this means that our authentication has passed inside the Login Component and we have a valid user
        // Set the authenticated property to true, and also store the user data
        this.authenticated = status;
        this.administrator = parseInt(data.iadmin); //make sure this is a number, not text
        this.user = data;
      },
